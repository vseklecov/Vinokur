...
const char PROCESS_START = 'P';
const char PROCESS_CANCEL = '@';
const char PROCESS_PREV_STATE = 'S';
const char PROCESS_NEXT_STATE = 'N';
const char PROCESS_SETTINGS = 'Q';

typedef enum washes {WASH_SUGAR, WASH_GRAIN, WASH_FRUIT, WASH_SPIRIT} washes;
typedef enum states {STATE_STOPS, STATE_HEAT, STATE_DISTIL, STATE_EQUIL, STATE_HEAD, STATE_HEART, STATE_TAILS, STATE_END, STATE_CANCEL} states;
...
public:
    ...
    inline boolean getCooling() { return _cooling>0;}
    inline boolean getHeating() { return _heating>0;}
    inline time_t getTimeBegin() { return time_begin; }
