...
void DistillationProcess::service()
{
    ...
    case STATE_END:
        ...
        {
            setHeating(0);
            _delay = millis() + 20000; // TODO: 20 СЃРµРєСѓРЅРґ
        }
    ...
    if (boiling_kub == 0.0 && _state == STATE_HEAT && getCooling())
    {
        ...
        {                                                    // 20 СЃРµРєСѓРЅРґ
            if (abs(_sp->getThempKub() - temp_boiling) < 0.15) // 20 СЃРµРєСѓРЅРґ РЅРµ РёР·РјРµРЅСЏРµС‚СЃСЏ С‚РµРјРїРµСЂР°С‚СѓСЂР°?
